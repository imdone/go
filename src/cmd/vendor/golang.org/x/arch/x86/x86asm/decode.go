...
//
// TODO (rsc): We may be able to merge various of the memory operands id:560 gh:561
...
// TODO (rsc): This is for testing. Only use this if a flag is given. id:717 gh:720
...
func decode1(src []byte, mode int, gnuCompat bool) (Inst, error) {
	...
	case 16, 32, 64:
		// ok
		// TODO (rsc): 64-bit mode not tested, probably not working. id:506 gh:507
	default:
...
Decode:
	for pc := 1; ; { // TODO uint id:657 gh:658
		oldPC = prevPC
		prevPC = pc
		if trace {
			println("run", pc)
		...
		case xArgMoffs8, xArgMoffs16, xArgMoffs32, xArgMoffs64:
			// TODO (rsc): Can address be 64 bits? id:999 gh:1007
		...
		case xArgMm2: // register only; TODO (rsc): Handle with tag modrm_regonly tag id:562 gh:563
			if haveMem {
				inst.Op = 0
				break Decode
			}
		...
		case xArgXmm2: // register only; TODO (rsc): Handle with tag modrm_regonly tag id:718 gh:718
			if haveMem {
				inst.Op = 0
				break Decode
			}
	...
	// TODO (rsc): Perhaps add these to the tables and id:508 gh:509
	...
	// TODO (rsc): Perhaps this instruction class should be derived from the CSV. id:660 gh:661
	...
	// TODO (rsc): Perhaps this instruction class should be derived from the CSV. id:1001 gh:1009
	...
	if lockIndex >= 0 && inst.Prefix[lockIndex]&PrefixImplicit == 0 {
		switch inst.Op {
		// TODO (rsc): Perhaps this instruction class should be derived from the CSV. id:564 gh:565
	...
	if repIndex >= 0 {
		...
		case PrefixREP, PrefixREPN:
			...
			// TODO (rsc): Perhaps this instruction class should be derived from the CSV. id:720 gh:721
			case INSB, INSW, INSD,
